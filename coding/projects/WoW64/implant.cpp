// author: reenz0h(twitter : @SEKTOR7net) credits: msf team
#include <winternl.h>
#include <windows.h>
#include <stdio.h>
#include <stdlib.h>
...
Injections:
[x] 64 bit payload & compiled -> 64-bit notepad process
[x] 32 bit payload & compiled -> 32-bit notepad process
[x] 32 bit payload & 64-bit compiled -> 32-bit notepad process
[x] 64 bit payload & 32 bit compiled -> 64-bit notepad process doesn't work with Inject function. Needs InjectWOW64 function
...
int main(void) {
	...
	if (pid) {
		...
		if (hProc != NULL) {
			...
			// [x] 32 bit payload & compiled -> 32-bit notepad process
			//Inject(hProc, payload32, payload32_len);
			
			// [x] 32 bit payload & 64-bit compiled -> 32-bit notepad process
			//Inject(hProc, payload32, payload32_len);
			
			//[] 64 bit payload & 32 bit compiled -> 64-bit notepad process
			// Doesn't work on my amd 5800x but it does on my laptop with intell cpu
